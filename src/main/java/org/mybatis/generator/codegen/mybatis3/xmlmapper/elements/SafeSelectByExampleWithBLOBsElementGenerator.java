 ...
 * @description
 */
public class SafeSelectByExampleWithBLOBsElementGenerator extends SelectByExampleWithBLOBsElementGenerator {
    public SafeSelectByExampleWithBLOBsElementGenerator() {
        super();
    }
